...
const request_cors_middleware_1 = require("./cors/request.cors.middleware");
const request_helmet_middleware_1 = require("./helmet/request.helmet.middleware");
...
let RequestMiddlewareModule = class RequestMiddlewareModule {
    configure(consumer) {
        consumer
            .apply(request_helmet_middleware_1.RequestHelmetMiddleware, request_id_middleware_1.RequestIdMiddleware, request_body_parser_middleware_1.RequestJsonBodyParserMiddleware, request_body_parser_middleware_1.RequestTextBodyParserMiddleware, request_body_parser_middleware_1.RequestRawBodyParserMiddleware, request_body_parser_middleware_1.RequestUrlencodedBodyParserMiddleware, request_cors_middleware_1.RequestCorsMiddleware, request_version_middleware_1.RequestVersionMiddleware, request_user_agent_middleware_1.RequestUserAgentMiddleware, request_timestamp_middleware_1.RequestTimestampMiddleware, request_timezone_middleware_1.RequestTimezoneMiddleware)
            .forRoutes('*');
    }
};
RequestMiddlewareModule = __decorate([
    (0, common_1.Module)({})
